...
<body>
 ...
 <img src="https://cdn-icons-png.flaticon.com/512/561/561127.png" 
  ...
  <div class="surat" id="suratContent">
    <h2>Hai, <?php echo e(request('nama')); ?>!</h2>
    <div class="typed-text" id="typed"></div>

    <div class="gallery">
        <img src="<?php echo e(asset('assets/galeri/foto10.jpg')); ?>">
        <img src="<?php echo e(asset('assets/galeri/foto8.jpg')); ?>">
        <img src="<?php echo e(asset('assets/galeri/foto6.jpg')); ?>">
        <img src="<?php echo e(asset('assets/galeri/foto3.jpg')); ?>">
    </div>
...
</html><?php /**PATH C:\laragon\www\11TKJ2\resources\views/surat/buka.blade.php ENDPATH**/ ?>